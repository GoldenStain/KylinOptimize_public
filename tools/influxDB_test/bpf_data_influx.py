...
# 将 sysbench 命令转换为字符串
command_str = ' '.join(commands[para_in][:15]) + " interval = 0.5s"

# print(command_str)
# sys.exit()

# 生成csv文件名
csv_filename = f"influx_result/output{test_count}.csv"

# 创建influx_result文件夹，如果不存在
os.makedirs('influx_result', exist_ok=True)
...
bpf = BPF(src_file="/home/xjbo/桌面/KylinDBOptimize/tools/bpf_data.c")
